"""
Automated Pytest for albi-albumin-bilirubin-grade Enrichment Modules.
"""
import sys
...
from enrichment import (
    EnrichmentmdEngine,
    LongitudinalAlbiTrendTrackingEngine,
    EhrIntegrationHl7FhirEngine,
    VisualDashboardEngine,
    AlertEscalationProtocolsEngine,
    PatientStratificationEngine,
    CrossinstitutionalAnalyticsEngine,
    AutomatedReportingEngine,
    AlbialbuminbilirubingradeEnrichmentSuite,
    enrichment_suite,
)

def test_enrichment_suite_execution():
    suite = AlbialbuminbilirubingradeEnrichmentSuite()
